...
pub async fn get_procedures_by_list_code_1c(list_code_1c: &HashMap<String, String>) -> Result<Vec<Procedure>> {
...
pub async fn get_procedures_by_list_code_1c_pool(pool: &PgPool, list_code_1c: &HashMap<String, String>) -> Result<Vec<Procedure>> {
